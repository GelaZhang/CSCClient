...
int DefaultProtocol::RecvSomething() {
	...
	char *buffer = NULL;
	int length = _diplomat->Peek(&buffer);
	if ( length > 0 ) {
...
int DefaultProtocol::ParseProtocolHeader(
		const char* data) {
...
int DefaultProtocol::GetProtocolHeader(
